...
class NStepDQNAgent:
    """N-step DQN Agent interacting with environment.
    
    Attribute:
        env (gym.Env): openAI Gym environment
        memory (NStepReplayBuffer): replay memory to store transitions
    ...
    def __init__(
        ...
        self.memory = NStepReplayBuffer(
            self.algorithm_name, self.env_name, 'memory', obs_dim, memory_size, batch_size, n_step=1
        )
